					...
					spellAuraApplied = {
						...
						args = {
							...
							druid = { -- AuraApplied
								...
								order = 7,
								args = listOption({102560,102543,102558,33891,61336,22812,22842,1850,69369,124974,102342,102351,155835,29166,194223,200851,203727,163505},"auraApplied"),
							},
							hunter = { -- AuraApplied
								type = 'group',
								inline = true,
							...
							mage = { -- AuraApplied
								...
								order = 9,
								args = listOption({45438,12042,12472,108839,198111,198144,86949,87024},"auraApplied"),
							},
							monk = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 10,
								args = listOption({201318,115203,122278,122783,115176,201325,116849,152175,152173,216113,197908,209584},"auraApplied"),
							},
							paladin = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 11,
								args = listOption({1022,1044,6940,199448,642,105809,224668,31884,31842,231895,152262,204150,31850,205191,184662,212641,86659,228049,182496,216331},"auraApplied"), 
							},
							priest	= { -- AuraApplied
								type = 'group',
								inline = true,
					...
					spellCastStart = {
						...
						args = {
							...
							warlock	= { -- CastStart
								...
								name = L["|cff9482C9Warlock|r"],
								order = 140,
								args = listOption({5782,710,152108,691,712,697,112866,112867,112870,112868,112869,30146,157757,157898,688,104316,30108,116858,30283,115268,6358},"castStart"),
							},
							--warrior = { -- CastStart
							--	type = 'group',
							--	inline = true,
					...
					spellCastSuccess = {
						...
						args = {
							...
							demonhunter = { -- CastSuccess
								...
								name = L["|cffA330C9Demon Hunter|r"],
								order = 50,
								args = listOption({179057,206649,205604,206803,205629,205630,202138,207684,202137,211881,203704,221527,196718,198013,201467,235903},"castSuccess"),
							},
							druid = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							hunter = { -- CastSuccess
								...
								name = L["|cffABD473Hunter|r"],
								order = 80,
								args = listOption({109248,109304,131894,126216,126215,126214,126213,122811,122809,122807,122806,122804,122802,121118,202914,208652,205691,201430,213691,187650,191241,201078,186387,120360,203415,1543,199483},"castSuccess"), 
							},
							mage = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cff69CCF0Mage|r"],
								order = 90,
								args = listOption({66,12051,30449,110959,153595,153561,198158,190319,205021,235219,235450,235313,11426},"castSuccess"),
							},
							monk = { -- CastSuccess
								type = 'group',
								inline = true,
