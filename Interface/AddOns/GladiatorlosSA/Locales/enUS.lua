...
L["Check this will disable alert for successfully-landed friendly interrupting abilities"] = "Disable all alerts for successful interrupts done by your allies. ('Countered!')"
L["Buff Applied"] = true
...
L["CastingSuccess_Desc"] = "Enables generic 'success' alert when a major enemy cast-time Crowd Control ability successfully finishes a cast.|n|nBe aware that this will announce even if the victim is unaffected, such as a target that is in a full Diminishing Return cycle.|n|n|cffC41F3BWARNING: ALL of the abilities below will announce their success if this is enabled, even if you have some of them disabled in Spell Casting.|r|n|nCyclone (|cffFF7D0ADruid|r)|nFreezing Arrow (|cffABD473Hunter|r)|nWyvern Sting (|cffABD473Hunter|r)|nPolymorph (|cff69CCF0Mage|r)|nRing of Frost (|cff69CCF0Mage|r)|nRepentance (|cffF58CBAPaladin|r)|nMind Control (Priest)|nHex (|cff0070daShaman|r)|nFear (|cff9482C9Warlock|r)"
...
L["FriendlyInterrupted"] = "Enemy Interrupts"
L["FriendlyInterruptedDesc"] = "Disable all alerts when an enemy successfully interrupts you or an ally. (Plays the Blizzard 'Quest Failed' sound effect.)"
