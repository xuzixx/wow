...
if GetLocale() == "zhCN"  then
	...
	TARGETCHARMS_LEFTCLICK = "左键点击应用标记"
	TARGETCHARMS_RIGHTDRAG="右键点击移动窗体"
	TARGETCHARMS_RIGHTSET="CTRL+右键点击打开配置"
	TARGETCHARMS_OPTIONS_TITLE = "目标标记选项";
	...
	TARGETCHARMS_READYCHECK_TEXT = "检查就绪";
...
elseif  GetLocale() == "zhTW" then
	TARGETCHARMS_TITLE = "TargetCharms";
	TARGETCHARMS_LEFTCLICK = "左鍵點擊應用標記"
	TARGETCHARMS_RIGHTDRAG="右鍵點擊移動窗體"
	TARGETCHARMS_RIGHTSET="CTRL+右鍵點擊打開配置"

TARGETCHARMS_OPTIONS_TITLE = "目標標記選項";
TARGETCHARMS_OPTIONS_LAYOUT_TEXT = "自定義：";
TARGETCHARMS_OPTIONS_DRAG = "可拖動";
TARGETCHARMS_OPTIONS_SHOWONTARGET = "有目標時顯示";
TARGETCHARMS_OPTIONS_TOGGLEICON = "再次點擊取消標記";
TARGETCHARMS_OPTIONS_SHOWICONS = "顯示圖標";
TARGETCHARMS_OPTIONS_SCALE = "大小";
TARGETCHARMS_OPTIONS_OPACITY = "透明度";
TARGETCHARMS_OPTIONS_XSPACING = "橫向間距";
TARGETCHARMS_OPTIONS_YSPACING = "縱向間距";
TARGETCHARMS_OPTIONS_SHOW_TITLE = "顯示：";
TARGETCHARMS_OPTIONS_CLOSE_BUTTON = "關閉";
TARGETCHARMS_OPTIONS_FLARE_MOVE_BUTTON = "移動世界標記";
TARGETCHARMS_OPTIONS_FLARE_LOCK_BUTTON = "鎖定世界標記";
TARGETCHARMS_OPTIONS_FLARE_MOVE_TEXT = "世界\n標記"
TARGETCHARMS_OPTIONS_PRESETS_TITLE = "選擇佈局：";
TARGETCHARMS_OPTIONS_LOAD_BUTTON = "設置佈局";
TARGETCHARMS_OPTIONS_READYCHECK_TITLE = "就緒按鈕選項";
TARGETCHARMS_OPTIONS_READYCHECK_TEXT = "文本：";
TARGETCHARMS_OPTIONS_FLARE_TITLE = "世界標記選項";
TARGETCHARMS_OPTIONS_WIDTH = "寬度";
TARGETCHARMS_READYCHECK_TEXT = "檢查就緒";
TARGETCHARMS_MSG_TAG = "TargetCharms：";
TARGETCHARMS_CMD_HELP = "/TargetCharms [Reset|Setup]";
TARGETCHARMS_SLASH1 = "/targetcharms";
TARGETCHARMS_SLASH2 = "/tc";
TARGETCHARMS_LOADED = "已載入";
TARGETCHARMS_ERROR_INVALIDCHAR = "無效字符位置";
...
TargetCharms_ShowTypes = {"小隊/團隊","總是","隱藏"};
end