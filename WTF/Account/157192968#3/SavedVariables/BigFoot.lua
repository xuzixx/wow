...
BigFoot_Error = {
	["ADDON_ACTION_FORBIDDEN"] = {
		["BigFoot"] = {
			...
			["race"] = "暗夜精灵",
			["time"] = 1481862536,
			["trace"] = "Interface\\AddOns\\BigFoot\\BigFootError.lua:1: in function `BigFootErrorFrame_OnEvent'\n[string \"*:OnEvent\"]:1: in function <[string \"*:OnEvent\"]:1>\n[C]: in function `SetAllowDangerousScripts'\nInterface\\FrameXML\\StaticPopup.lua:3633: in function `OnAccept'\nInterface\\FrameXML\\StaticPopup.lua:4260: in function `StaticPopup_OnClick'\n[string \"*:OnClick\"]:1: in function <[string \"*:OnClick\"]:1>\n",
			["level"] = 110,
			["forbiddenfunc"] = "SetAllowDangerousScripts()",
			["version"] = "zhCN7.1.0.605",
		},
	},
	["debug_Mod"] = false,
}
